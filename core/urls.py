...
urlpatterns = [
    ...
    path('panel/areas/', views.admin_areas, name='admin_areas'),
    path('panel/areas/crear/', views.admin_crear_area, name='admin_crear_area'),
    path('panel/areas/<int:area_id>/editar/', views.admin_editar_area, name='admin_editar_area'),
    path('panel/areas/<int:area_id>/eliminar/', views.admin_eliminar_area, name='admin_eliminar_area'),
